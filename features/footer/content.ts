      ...
      links: [
        {
          ...
          href: "/products/corporate-air-purifier",
          isActive: true,
        },
        {
          id: "sol-healthcare",
          label: "Healthcare & Clinical",
          href: "/products/healthcare-air-purifier",
          isActive: true,
        },
        {
          id: "sol-residential",
          label: "Residential",
          href: "/residential-air-purifier",
          isActive: true,
        },
        {
          id: "sol-industrial",
          label: "Industrial & Manufacturing",
          href: "/products/industrial-air-purifier",
          isActive: true,
        },
        {
          id: "sol-education",
          label: "Education",
          href: "/products/education-air-purifier",
          isActive: true,
        },
        {
          id: "sol-datacenter",
          label: "Data Centres",
          href: "/products/datacenter-air-purifier",
          isActive: true,
        },
      ],
    },
