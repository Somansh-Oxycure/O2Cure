        ...
        >
          ...
          <div className="border-t border-[#E5E7EB]/60 bg-white/80 px-4 pb-6 pt-4 backdrop-blur-xl">
            <button
              ...
              className="group flex w-full items-center justify-center gap-2.5 rounded-2xl bg-[#C5A059] py-4 text-[0.9rem] font-semibold text-white shadow-lg shadow-[#C5A059]/25 transition-all duration-300 active:scale-[0.98]"
