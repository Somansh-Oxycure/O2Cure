...
interface CommercialSpatialLayoutStepProps {
  selected: string;
...
function LayoutChip({
  ...
  return (
    <button
      ...
      className={`group relative flex items-center gap-4 rounded-2xl border p-5 text-left transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] ${
        isSelected
          ? "border-[#2563EB] bg-[#F8FAFC] shadow-md shadow-[#2563EB]/10"
...
export function CommercialSpatialLayoutStep({ selected, onChange }: CommercialSpatialLayoutStepProps) {
  return (
    <div className="pt-2">
