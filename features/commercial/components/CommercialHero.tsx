...
export function CommercialHero({ onBeginDiagnostic }: CommercialHeroProps) {
  return (
    <section
      id="commercial-hero"
      className="relative min-h-[92vh] w-full overflow-hidden flex items-end justify-start pb-16 md:pb-24"
      aria-label="Commercial Air Purification Hero"
    >
      ...
      >
        <Image
          src="/residential/HERO.png" // User requested specific image
          alt="Luxurious, healthy commercial interior — O2Cure enterprise air purification"
          fill
          priority
      ...
      <div className="relative z-10 w-full max-w-2xl px-6 md:px-12 text-left">
        ...
        >
          ...
          >
            <p className="text-[0.7rem] font-bold uppercase tracking-[0.2em] text-[#3B82F6]">
              TRUSTED COMMERCIAL AIR EXPERTS
            </p>
          </motion.div>
          ...
          >
            For Healthy and Productive Workplace
          </motion.h1>
          ...
          >
            <button
              ...
              className="group relative inline-flex items-center gap-3 overflow-hidden rounded-full bg-[#2563EB] px-8 py-3.5 text-[0.95rem] font-semibold tracking-wide text-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-500 hover:bg-[#1D4ED8] hover:-translate-y-0.5"
              aria-label="Begin your workspace air assessment"
            >
              <span className="relative z-10">Fix My Air Quality</span>
              <svg
