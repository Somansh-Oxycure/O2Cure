      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-[clamp(2rem,5vw,4rem)]">
        <div className="grid gap-14 lg:grid-cols-[1fr_minmax(0,1.05fr)] lg:gap-[clamp(2.5rem,5vw,6rem)] xl:gap-20 items-start">
          ...
          <div className="flex flex-col">
            ...
            >
              <span className="h-[1px] w-8 bg-[#2563EB]" aria-hidden />
              <span className="text-[0.65rem] font-semibold tracking-[0.2em] uppercase text-[#2563EB]">
                Get in Touch
              </span>
            </motion.div>
            ...
            <motion.h2
              ...
              className="text-[clamp(1.9rem,4vw,3rem)] font-semibold leading-[1.06] tracking-[-0.02em] text-[#0F172A]"
            >
              Speak with an{" "}
              <span className="text-[#2563EB]">air quality</span>
              <br />
              engineer today.
            </motion.h2>
            ...
            >
              {CONSULTATION_HIGHLIGHTS.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 shrink-0 mt-0.5 text-[#2563EB]" />
                  <span className="text-[0.9rem] font-medium text-[#0F172A]">{item}</span>
                </li>
              ))}
            </motion.ul>
            ...
            <motion.div 
              ...
              className="mt-8 inline-flex items-center gap-4 rounded-2xl border border-[#2563EB]/20 bg-[#F8FAFC] px-5 py-4"
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#2563EB]/10">
                <Clock className="h-5 w-5 text-[#2563EB]" />
              </div>
              <div>
                <p className="text-[0.8rem] font-semibold text-[#0F172A]">
            ...
            >
              {CONTACT_DETAILS.map((detail) => (
                ...
                >
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-100 bg-[#F8FAFC] transition-colors duration-200 group-hover:border-[#2563EB]/30 group-hover:bg-[#2563EB]/5">
                    <detail.icon className="h-4 w-4 text-gray-400 group-hover:text-[#2563EB] transition-colors duration-200" />
                  </div>
                  <div>
                    <p className="text-[0.65rem] font-semibold tracking-widest text-[#475569] uppercase">
                      {detail.label}
                    </p>
                    <p className="text-[0.85rem] font-semibold text-[#0F172A] mt-1">
                      {detail.value}
                    </p>
          ...
          <motion.div 
            ...
            className="rounded-3xl border border-[#2563EB]/20 bg-white p-6 shadow-xl shadow-[#2563EB]/5 md:p-8"
          >
            {/* Using the CommercialEnquiryForm */}
