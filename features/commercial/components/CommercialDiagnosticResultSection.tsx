...
export function CommercialDiagnosticResultSection({
  recommendation,
  onReset,
}: CommercialDiagnosticResultSectionProps) {
  return (
    <motion.section
        ...
        >
          ...
          <div className="relative h-64 w-full overflow-hidden md:h-80">
            ...
            <div className="absolute left-5 top-5">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/95 px-4 py-1.5 text-[0.7rem] font-bold uppercase tracking-[0.15em] text-[#0F172A] backdrop-blur-md shadow-sm">
          ...
          <div className="p-8">
            {/* System name + tagline */}
            <h3 className="text-[1.6rem] font-semibold tracking-[-0.01em] text-[#0F172A]">
              {recommendation.systemName}
            </h3>
            <p className="mt-1 text-[0.85rem] font-medium text-[#2563EB]">
            ...
            <div className="mt-7 grid grid-cols-2 gap-4 sm:grid-cols-3">
              <div className="rounded-xl border border-gray-100 bg-[#F8FAFC] p-4 text-center transition-colors hover:border-[#2563EB]/30">
                <p className="text-[0.7rem] font-semibold uppercase tracking-[0.1em] text-[#475569]">
                  Target CFM
                </p>
                <p className="mt-1.5 text-[1.1rem] font-semibold text-[#0F172A]">
              ...
              {recommendation.nabl && (
                <div className="rounded-xl border border-[#2563EB]/20 bg-[#F8FAFC] p-4 text-center transition-colors hover:border-[#2563EB]/40">
                  <p className="text-[0.7rem] font-semibold uppercase tracking-[0.1em] text-[#2563EB]">
                    Lab Status
                  </p>
                  <p className="mt-1.5 text-[0.9rem] font-bold text-[#2563EB]">
                    NABL Tested
                  </p>
                </div>
              )}
            ...
            {/* TriCure™ pillars */}
            <div className="mt-7">
              <p className="mb-3 text-[0.75rem] font-semibold uppercase tracking-[0.15em] text-[#475569]">
              ...
              <div className="flex flex-wrap gap-2.5">
                {recommendation.tricurePillars.map((p) => {
                  ...
                  return (
                    <span
                      key={p}
                      className={`inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-[0.75rem] font-medium border border-transparent hover:border-[#2563EB]/20 transition-colors ${c.bg} ${c.text}`}
                    >
            ...
            <div className="mt-8 flex items-center justify-between border-t border-gray-100 pt-6">
              <a
                ...
                className="inline-flex items-center gap-2 text-[0.85rem] font-medium text-[#2563EB] transition-colors hover:text-[#1D4ED8]"
              >
