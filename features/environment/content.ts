...
export const environments: Environment[] = [
  {
    ...
    icon: Home,
    image: {
      src: "/enviroment/residential.webp",
      alt: "Sunlit modern living room with clean architectural lines",
      collapsedSrc: "/enviroment/residential.webp",
    },
  ...
  },
  {
    ...
    icon: Building2,
    image: {
      src: "/enviroment/commertial.webp",
      alt: "Premium open-plan office with natural light",
      collapsedSrc: "/enviroment/commertial.webp",
    },
  ...
  },
  {
    ...
    icon: Factory,
    image: {
      src: "/enviroment/industrial.webp",
      alt: "Modern industrial facility with controlled environment",
      collapsedSrc: "/enviroment/industrial.webp",
    },
  ...
  },
  {
    ...
    icon: HeartPulse,
    image: {
      src: "/enviroment/hospital.webp",
      alt: "Bright, minimal hospital corridor",
      collapsedSrc: "/enviroment/hospital.webp",
    },
  ...
  },
  {
    ...
    icon: GraduationCap,
    image: {
      src: "/enviroment/education.webp",
      alt: "Contemporary university campus interior",
      collapsedSrc: "/enviroment/education.webp",
    },
  ...
  },
  {
    ...
    icon: Landmark,
    image: {
      src: "/enviroment/datacenters.webp",
      alt: "Modern civic building with glass facade",
      collapsedSrc: "/enviroment/datacenters.webp",
    },
